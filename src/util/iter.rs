pub trait IteratorExt: Iterator {
    ...
    fn try_flat_map_into_ref<Collection: Extend<T>, T, I: IntoIterator<Item = T>, E>(
        self,
        collection: &mut Collection,
        mut mapper: impl FnMut(Self::Item) -> Result<I, E>,
    ) -> Result<&mut Collection, E>
    where
        Self: Sized,
    {
    ...
    fn try_flat_map_into<Collection: Extend<T>, T, I: IntoIterator<Item = T>, E>(
        self,
        mut collection: Collection,
        mapper: impl FnMut(Self::Item) -> Result<I, E>,
    ) -> Result<Collection, E>
    where
        Self: Sized,
    {
        self.try_flat_map_into_ref(&mut collection, mapper)?;
        Ok(collection)
    }

    fn try_flat_map_into_default<Collection: Default + Extend<T>, T, I: IntoIterator<Item = T>, E>(
        self,
        mapper: impl FnMut(Self::Item) -> Result<I, E>,
    ) -> Result<Collection, E>
    where
        Self: Sized,
    {
        self.try_flat_map_into(Collection::default(), mapper)
    }
}
